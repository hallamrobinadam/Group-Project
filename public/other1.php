<!-- This page differs from the normal other.php as its functions is to show just the users posts of a certain caetgory. -->
...
<?php include("../includes/templates/banner.php"); ?>
                        ...
                        <div class = "container">
                            ...
                            <legend>Your Other Deals</legend>
                        ...
                        <!-- Box which will display just users other posts -->
                        <div class="container">
                <div class="row">
                    <div class="col-md-10">

                        <?php
                            $query = "SELECT * FROM sobu WHERE user_id ='$_SESSION[user_id]' AND category='Other'";
