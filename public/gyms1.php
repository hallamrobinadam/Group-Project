<!-- This page differs from the normal gyms.php as its functions is to show just the users posts of a certain caetgory. -->
...
<?php include("../includes/templates/banner.php"); ?>
                        ...
                        <!-- Box which will display just users gym posts -->
                        <div class="container">
                <div class="row">
                    <div class="col-md-10">

                        <?php
                            $query = "SELECT * FROM sobu WHERE user_id ='$_SESSION[user_id]' AND category='Gyms'";
