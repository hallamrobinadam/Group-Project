...
<?php include("../includes/templates/banner.php"); ?>
        ...
        <div class="col-lg-4">
            ...
            <p>Hi, my name is Hallam Ager. I'm 19 and from Norwich. I have keen interests in sports, music and all forms of media. </p>
                </div>
                <div class="col-lg-4">
            <h2> Robin Osolinski</h2>
            <img src="images/adamprofile.jpg" class="img-responsive"/> 
            <p>Hi my name's Robin Osolinski, I'm 20 and I'm from Sweden. My main interests are music, films and books. </p>
                </div>
            </div>
        </div>
            <div class="container"> 
